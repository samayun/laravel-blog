        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="/quaxlab/images/logo.png" alt=""> </b>
                    <span class="logo-compact"><img src="/quaxlab/images/logo-compact.png" alt=""></span>
                    <span class="brand-title">
                        <img src="/quaxlab/images/logo-text.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="/quaxlab/images/avatar/1.jpg" alt="">
